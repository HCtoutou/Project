/*
 *  Name: crtsurfdata4.cpp 本程序用于生成全国气象站点观测的分钟数据
 *  Author: HCtoutou
 *  将观测数据容器中的记录写入文件  生成csv文件 
 */
...
int main(int argc,char *argv[])
{
  ...
  if (argc != 5)
  {
    ...
    printf("Example:/project/idc1/bin/crtsurfdata4 /project/idc1/ini/stcode.ini /tmp/idc/surdfata /log/idc/crtsurfdata4.log xml,json,csv\n\n");
