...
int main(int argc,char *argv[])
{
  ...
  if (argc!=5)
  {
    ...
    printf("Example:/project/tools1/bin/procctl 120 /project/idc1/bin/obtcodetodb /project/idc/ini/stcode.ini \"192.168.92.128,root,123456,mysql,3306\" utf8 /log/idc/obtcodetodb.log\n\n");
...
bool LoadSTCode(const char *inifile)
{
  ...
  // 打开站点参数文件
  if (File.Open(inifile,"r")==false)  // 打开文件失败
  {
  ...
  while(true)
  {
    ...
    // 把读取到的一行拆分
    CmdStr.SplitToCmd(strBuffer,",",true);// true表=表示删除分割字符前后的空格
